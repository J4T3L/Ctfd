...
# Format: (id, name, cat, level, pts, desc, link, tool, hint)
CHALLENGES = [
    ...
    ("crypto-18", "Legacy MD5 Hash Crack", "crypto", "MEDIUM", 200, "Cracking MD5 password hash.", "/weak_hash/", "hashcat / john / CrackStation", "Salin hash MD5 e10adc3949ba59abbe56e057f20f883e. Gunakan hashcat -m 0 e10adc3949ba59abbe56e057f20f883e rockyou.txt untuk mendapatkan password."),
    ("crypto-19", "RSA Small Exponent e=3", "crypto", "MEDIUM", 300, "RSA Low Exponent m = c^(1/3).", "/handout/19_rsa_e3.json", "Python 3 / SymPy", "Buka file 19_rsa_e3.json. Karena e=3 sangat kecil (c < n), hitung nilai m dengan menghitung akar pangkat tiga dari ciphertext: m = c**(1/3)."),
    ("crypto-20", "RSA Prime Factorization", "crypto", "MEDIUM", 350, "RSA Factorization (p * q).", "/handout/20_rsa_factor.json", "factordb.com / SageMath", "Buka file 20_rsa_factor.json. Masukkan nilai n=493 ke factordb.com untuk menemukan p=17 dan q=29, lalu dekripsi ciphertext c."),
    ...
    ("crypto-23", "AES-128 ECB Pattern", "crypto", "HARD", 400, "AES ECB Block Alignment Leak.", "/handout/23_aes_ecb.hex", "Python 3 / CyberChef", "Buka file 23_aes_ecb.hex. Analisis blok hex 16-byte identik pada ECB mode yang mengindikasikan struktur data plaintext."),
    ...
    ("crypto-25", "Diffie-Hellman Weak Mod", "crypto", "HARD", 500, "Diffie-Hellman Discrete Logarithm.", "/handout/25_dh_params.json", "SageMath / Pari-GP", "Buka file 25_dh_params.json. Hitung Discrete Logarithm Problem g^a = A (mod p) pada p=23 yang sangat kecil menggunakan SageMath."),
...
if __name__ == "__main__":
    generate_portal()
    print("[🎉] portal.html generated with 50 Challenge cards and Interactive Hint Modal Popups!")
